package com.lbh.web.restful.controller;

import com.fasterxml.jackson.annotation.JsonFormat;
import com.lbh.web.restful.common.AjaxResponse;
import com.lbh.web.restful.model.Article;
...
public class ArticleController {
    ...
    public AjaxResponse getArticle(@PathVariable("id") Long id) {
        Article article = Article.builder().id(id).author("lbh").content("SpringBoot青铜").title("SpringBoot").createTime(new Date()).build();
